...
<div class="login-wrap">
	<div class="row align-items-center">
	  <div class="banner-login d-none d-lg-block col-lg-6">
		...
		<div class="form-wrap-login col-12 col-lg-6">
			...
			<?php endif; ?>
				...
				<?php if ($this->params->get('logindescription_show') == 1) : ?>
					<h2 class="mt-0"><?php echo $this->params->get('login_description'); ?></h2>
				<?php endif; ?>
	        ...
	        <div class="row g-0 action">
	          <!--Button Submit-->
	          <div class="col-7 login-submit control-group">
	            <div class="controls">
	              <button type="submit" class="btn btn-secondary">
	                <?php echo Text::_('TPL_LOGIN'); ?>
	              </button>
	            </div>
	          </div>
	          
	          <div class="register-redirect col-5 ">
	            <!--Button Register-->
	            <?php if ($usersConfig->get('allowUserRegistration')) : ?>
	              <a class="btn btn-outline-primary" href="<?php echo Route::_('index.php?option=com_users&view=registration'); ?>" >
	                <?php echo Text::_('TPL_REGISTER'); ?>
	              </a>
	            <?php endif; ?>
	          </div>
	        </div>
