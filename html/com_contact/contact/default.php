...
JText::script('TPL_CONTACT_CONTACT_EMAIL_NAME_LABEL');
JText::script('TPL_CONTACT_EMAIL_LABEL');
JText::script('TPL_CONTACT_CONTACT_MESSAGE_SUBJECT_LABEL');
JText::script('TPL_CONTACT_CONTACT_ENTER_MESSAGE_LABEL');
