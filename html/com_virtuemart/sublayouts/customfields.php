...
if (!empty($product->customfieldsSorted[$position])) {
	?>
	<div class="pd-detail-item <?php echo $class?>">
		<?php
		if($customTitle and isset($product->customfieldsSorted[$position][0])){
			$field = $product->customfieldsSorted[$position][0]; ?>
		<div class="product-fields-title-wrapper"><div class="product-fields-title"><h2><?php echo Text::_('TPL_RELATED_PRODUCT'); ?></h2></div>
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			?>			
			<div class="item col-12 col-md-6 col-xl-3 product-field product-field-type-<?php echo $field->field_type ?>">
