...
?>
<div class="com-content-article detail-team-wrap item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	<div class="top-info">
		<div class="container">
			<div class="row">
		            ...
		            <?php endif; ?>
						...
						<div class="statics-wrap">
							...
							<ul>
								...
								<?php if($teamHeight) :?>
									<li>
										<span><?php echo Jtext::_('TPL_HEIGHT') ;?></span>
										<h3><?php echo $teamHeight ;?></h3>
									</li>
								<?php endif ;?>

								<?php if($teamWeight) :?>
									<li>
										<span><?php echo Jtext::_('TPL_WEIGHT') ;?></span>
										<h3><?php echo $teamWeight ;?></h3>
									</li>
								<?php endif ;?>

								<?php if($teamShot) :?>
									<li>
										<span><?php echo Jtext::_('TPL_SHOT') ;?></span>
										<h3><?php echo $teamShot ;?></h3>
									</li>
								<?php endif ;?>

								<?php if($teamPlayed) :?>
									<li>
										<span><?php echo Jtext::_('TPL_PLAYED') ;?></span>
										<h3><?php echo $teamPlayed ;?></h3>
									</li>
								<?php endif ;?>

								<?php if($teamGoal) :?>
									<li>
										<span><?php echo Jtext::_('TPL_GOAL') ;?></span>
										<h3><?php echo $teamGoal ;?></h3>
									</li>
								<?php endif ;?>
							</ul>
						</div>
	...
	<?php if ($params->get('show_fullinfo')) : ?>
	<div class="container">
