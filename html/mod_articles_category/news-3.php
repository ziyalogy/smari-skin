...
?>
<div id="slide-articles-<?php echo $module->id; ?>" class="mod-articles-cw mod-articles-slide-3 <?php echo $moduleclass_sfx; ?>" >
			...
			<div class="owl-carousel">
				<?php $i=1; foreach ($list as $item) : ?>
					<?php $attribs = new JRegistry ($item->attribs);
						...
						<div class="item-inner <?php if($i%3==0) echo 'item-highlight' ;?>" data-dot="<?php echo $i ;?>">
