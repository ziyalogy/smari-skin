...
?>
<div id="slide-articles-<?php echo $module->id; ?>" class="mod-articles-cw mod-articles-slide-4 <?php echo $moduleclass_sfx; ?>" >
	<?php if ($grouped) : ?>
		...
		<div class="owl-carousel">
			<?php $i=1; foreach ($list as $item) : ?>
				<?php $attribs = new JRegistry ($item->attribs);
					...
					<div class="item-inner <?php if($i%3==0) echo 'item-highlight' ;?>" data-dot="<?php echo ($i<10) ? '0'.$i : $i ;?>">
