...
<body class="offline">
	...
	<div id="frame" class="outline">
		...
		<div class="form-wrap d-flex justify-content-center mx-auto vh-100">
      ...
      <div class="content-right d-none d-lg-block col-lg-6 ">
        <!-- Offline Image -->
        <?php if ($app->get('offline_image')) : ?>
          <div class="offline-image h-100">
            <?php echo HTMLHelper::_('image', $app->get('offline_image'), $app->get('sitename'), [], false, 0); ?>
          </div>
        <?php else: ?>
          <div class="offline-image h-100">
            <img src="<?php echo $this->baseurl; ?>/templates/ja_sport/images/others/offline.png" alt="Offline Image">
          </div>
        <?php endif; ?>
      </div>
